...
class CycleCategoriserTest {
	...
	@Test
	void testCycleCategoriser1() {
		UtilArgs.parseArgs(args1);
		CycleCategoriser<Integer> cat = new CycleCategoriser<Integer>(UtilAF.parseRankingAF());
		cat.resolve();
